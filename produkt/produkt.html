...
<h3>Velg ein kategori:</h3>
 
<div class="kategori-container">
  <button class="kategori-knapp" on:click={() => visKategori("")}>
    <img src="/bilderprosjekt/alle.png" alt="Alle kategoriar">
    Alle kategoriar
  </button>
...
<h1>{valgtKategori ? valgtKategori.charAt(0).toUpperCase() + valgtKategori.slice(1) : "Alle produkt"}</h1>
...
<section class="Produkt">
  ...
  <div class="ni-kolonnar ei-rad">
    ...
    <div class="produkt-info">
      ...
      <span>Antal: {produkt.lagerantall} stk</span>
    </div>
